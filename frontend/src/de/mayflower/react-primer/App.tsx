...
{
    static defaultProps:rp.AppProps = { title: 'The default title!!' };
    ...
    */
    public componentWillUpdate( nextProps:rp.AppProps, nextState:rp.AppState, nextContext:React.Context<any> ) : void
    {
    ...
    *   @param nextContext The context to set on updating.
    */
    public componentWillReceiveProps( nextProps:rp.AppProps, nextContext:React.Context<any> ) : void
    {
